...
c maxiter is the number of time steps in the model run.
      parameter (maxiter=8784) ! mgc 2016 is leap year
...
c mgc write out year month day and hour
...
c Save the ice data.
            ...
            do k=1,JJ
              write (20,*) k,T_old(k)-Tf,gamma(k),xmelt(k),water_frac(k)
            enddo
